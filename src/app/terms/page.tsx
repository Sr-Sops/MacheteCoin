    ...
    <div style={{
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ fontSize: '0.85rem', margin: 0, color: 'var(--text-secondary)', lineHeight: 1.5 }}>
              MacheteCoin (<span style={{ display: 'inline-flex', alignItems: 'center', gap: '0.15em', verticalAlign: 'middle', marginTop: '-0.1em' }}><Image src="/logo-oficial.png" alt="$" width={14} height={14} style={{ width: '1em', height: '1em' }} /> MacheteCoin</span>) es un token de tipo meme creado exclusivamente con fines de entretenimiento y diversión comunitaria. No tiene utilidad práctica, respaldo financiero ni garantía de valor intrínseco. No arriesgues fondos que no puedas permitirte perder por completo.
            </p>
          </div>
        </div>
        ...
        <div className="glass-panel" style={{ display: 'flex', flexDirection: 'column', gap: '2rem', padding: '2.5rem', lineHeight: 1.7 }}>
          ...
          <section>
            <h3 style={{ color: 'var(--color-gold)', fontSize: '1.25rem', borderBottom: '1px solid rgba(255,255,255,0.05)', paddingBottom: '0.5rem', marginBottom: '0.75rem' }}>
              2. Naturaleza del Token <span style={{ display: 'inline-flex', alignItems: 'center', gap: '0.15em', verticalAlign: 'middle', marginTop: '-0.1em' }}><Image src="/logo-oficial.png" alt="$" width={20} height={20} style={{ width: '1em', height: '1em' }} /> MacheteCoin</span>
            </h3>
            <p style={{ fontSize: '0.95rem', color: 'var(--text-secondary)' }}>
              El token <span style={{ display: 'inline-flex', alignItems: 'center', gap: '0.15em', verticalAlign: 'middle', marginTop: '-0.1em' }}><Image src="/logo-oficial.png" alt="$" width={14} height={14} style={{ width: '1em', height: '1em' }} /> MacheteCoin</span> es una moneda de broma (&quot;meme coin&quot;). No constituye una inversión, un valor financiero (security), un contrato de inversión ni confiere derechos de voto ni de participación en ninguna empresa. La adquisición de <span style={{ display: 'inline-flex', alignItems: 'center', gap: '0.15em', verticalAlign: 'middle', marginTop: '-0.1em' }}><Image src="/logo-oficial.png" alt="$" width={14} height={14} style={{ width: '1em', height: '1em' }} /> MacheteCoin</span> no debe realizarse con la expectativa de obtener plusvalías o beneficios financieros.
            </p>
          </section>
          ...
          <section>
            ...
            <ul style={{ paddingLeft: '1.5rem', marginTop: '0.5rem', color: 'var(--text-secondary)', fontSize: '0.95rem' }}>
              ...
              <li>Cualquier fluctuación de precio drástica del token <span style={{ display: 'inline-flex', alignItems: 'center', gap: '0.15em', verticalAlign: 'middle', marginTop: '-0.1em' }}><Image src="/logo-oficial.png" alt="$" width={14} height={14} style={{ width: '1em', height: '1em' }} /> MacheteCoin</span> en mercados secundarios descentralizados (DEX).</li>
